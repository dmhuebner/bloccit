class SponsoredPostsController < ApplicationController
	...
	def update
		...
		if @sponsored_post.save
			...
			flash[:alert] = "There was an error saving your chages to the sponsored post. Please try again."
			render :edit
		end
	end
	...
	def destroy
		...
		if @sponsored_post.destroy
			...
			flash[:alert] = "There was an error deleting the sponsored post. Please try again."
			render :show
		end
	end
end
