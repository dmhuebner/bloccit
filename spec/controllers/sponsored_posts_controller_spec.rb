...
RSpec.describe SponsoredPostsController, type: :controller do
	...
	describe "POST create" do
		it "increases the number of SponsoredPost by 1" do
			expect{post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_num}}
		end
		...
		it "redirects to the next post" do
			post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_num}
  	...
  	describe "GET edit" do
		...
		it "assigns sponsored_post to be updtaed to @sponsored_post" do
			get :edit, topic_id: my_topic.id, id: my_sponsored_post.id
	...
	describe "DELETE destroy" do
		...
		it "redirects to topic show" do
			delete :destroy, topic_id: my_topic.id, id: my_sponsored_post
